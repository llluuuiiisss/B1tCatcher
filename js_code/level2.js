...
function createObstacles() {
    ...
    obstacle.style.width = '250px';
    obs.push(obstacle);
    obstacle1 = new Image();
    obstacle1.src = "../resources/bin_.png";
    document.body.appendChild(obstacle1);
    obstacle1.style.position = "absolute";
    obstacle1.style.top = '65px';
    obstacle1.style.left = '400px';
    obstacle1.style.height = '250px';
    ...
    obstacle2.style.top = '160px';
    obstacle2.style.left = '1045px';
    obstacle2.style.height = '20px';
    obstacle2.style.width = '250px';
    obs.push(obstacle2);
}
...
function moveLeft(){
    if((parseInt(objImage.style.top)>335)&&(parseInt(objImage.style.top)<425)&&(parseInt(objImage.style.left)<280)){
        //Garantir que nao anda
    }
    else if((parseInt(objImage.style.top)<320)&&(parseInt(objImage.style.left)>335)&&(parseInt(objImage.style.left)<430)){

    }
    else if(parseInt(objImage.style.left)-10 > (28)) {//antes tava 28
        objImage.style.left=parseInt(objImage.style.left)-15 +'px';
    }
}

function moveUp(){
    if((parseInt(objImage.style.left)<275)&&(parseInt(objImage.style.top)<430)&&(parseInt(objImage.style.top)>355)){
        //Garantir que nao anda
    }
    else if((parseInt(objImage.style.top)<325)&&(parseInt(objImage.style.left)>335)&&(parseInt(objImage.style.left)<425)){

    }
    else if((parseInt(objImage.style.left)>980)&&(parseInt(objImage.style.top)<190)&&(parseInt(objImage.style.top)>95)){
...
function moveRight(){
    if((parseInt(objImage.style.top)<320)&&(parseInt(objImage.style.left)>330)&&(parseInt(objImage.style.left)<430)){

    }
    else if((parseInt(objImage.style.left)>975)&&(parseInt(objImage.style.top)<185)&&(parseInt(objImage.style.top)>95)){
...
function moveDown(){
    if((parseInt(objImage.style.left)<275)&&(parseInt(objImage.style.top)>330)&&(parseInt(objImage.style.top)<425)){
        //Garantir que nao anda
    }
    else if((parseInt(objImage.style.left)>980)&&(parseInt(objImage.style.top)<185)&&(parseInt(objImage.style.top)>90)){
